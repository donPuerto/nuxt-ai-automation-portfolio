...
export default defineNuxtConfig({
  ...
  runtimeConfig: {
    ...
    n8nAskDonWebhookUrl: process.env.N8N_ASK_DON_WEBHOOK_URL ?? process.env.NUXT_N8N_ASK_DON_WEBHOOK_URL ?? '',
    n8nAskDonWebhookToken: process.env.N8N_ASK_DON_WEBHOOK_TOKEN ?? process.env.NUXT_N8N_ASK_DON_WEBHOOK_TOKEN ?? '',
