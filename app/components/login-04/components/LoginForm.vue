        ...
        <form class="p-6 md:p-8">
          <FieldGroup>
            ...
            <Field>
              ...
              <Input id="password" type="password" required class="border-[#4a433d] bg-[#221f1d] text-[#fff4e6]" />
            </Field>
            <Field>
              <Button type="submit" class="w-full bg-[#b87449] text-white hover:bg-[#c6845a]">
                Login
              </Button>
            </Field>
            ...
            <Field class="grid grid-cols-3 gap-4">
              <Button variant="outline" type="button" class="border-[#4a433d] bg-[#221f1d] text-[#f0deca] hover:bg-[#2d2926] hover:text-[#fff4e6]">
