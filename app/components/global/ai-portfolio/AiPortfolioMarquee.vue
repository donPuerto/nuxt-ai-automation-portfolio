...
<template>
  <div class="relative overflow-hidden rounded-full border border-border/60 bg-background/55 px-3 py-2 shadow-sm backdrop-blur">
    <div class="pointer-events-none absolute inset-y-0 left-0 z-10 w-20 bg-gradient-to-r from-background via-background/80 to-transparent" />
    <div class="pointer-events-none absolute inset-y-0 right-0 z-10 w-20 bg-gradient-to-l from-background via-background/80 to-transparent" />

    <div class="flex w-max min-w-full animate-[marquee_34s_linear_infinite] gap-3 pr-3 hover:[animation-play-state:paused]">
