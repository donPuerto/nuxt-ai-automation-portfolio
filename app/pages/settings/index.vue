      ...
      <Card class="border-border/70 bg-card text-card-foreground">
        <CardContent class="grid gap-0 p-0 lg:grid-cols-[13.25rem_minmax(0,1fr)]">
          ...
          <section class="p-3 md:p-4 lg:p-5">
            <div v-if="isSettingsBootstrapping" class="space-y-3">
              <Skeleton class="h-7 w-40 bg-muted" />
              <Skeleton class="h-20 w-full bg-muted" />
              <Skeleton class="h-20 w-full bg-muted" />
            </div>
                ...
                <div class="space-y-5">
                  ...
                  <div class="space-y-2">
                    ...
                    <Textarea
                      ...
                      rows="4"
                      class="min-h-[110px] sm:min-h-[120px] rounded-xl border-border bg-background text-[15px] text-foreground placeholder:text-muted-foreground focus-visible:ring-1 focus-visible:ring-primary/50"
                    />
                  </div>
