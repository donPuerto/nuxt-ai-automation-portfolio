...
export const accentPresets: AccentPreset[] = [
  ...
  },
  {
    ...
    dark: {
      ...
      chart1: 'oklch(0.712 0.194 13.428)',
      chart2: 'oklch(0.645 0.246 16.439)',
      chart3: 'oklch(0.823 0.12 19.571)',
      chart4: 'oklch(0.586 0.253 17.585)',
      chart5: 'oklch(0.91 0.053 17.693)',
      sidebarPrimary: 'oklch(0.712 0.194 13.428)',
      sidebarPrimaryForeground: 'oklch(0.205 0 0)',
      sidebarRing: 'oklch(0.712 0.194 13.428)',
      selection: 'oklch(0.712 0.194 13.428)',
      selectionForeground: 'oklch(0.205 0 0)',
    },
  },
  {
    ...
    swatch: '#ea580c',
    light: {
      primary: 'oklch(0.67 0.173 47.604)',
      primaryForeground: 'oklch(0.985 0 0)',
      ring: 'oklch(0.67 0.173 47.604)',
      chart1: 'oklch(0.67 0.173 47.604)',
      chart2: 'oklch(0.75 0.183 55.934)',
      chart3: 'oklch(0.607 0.176 52.982)',
      chart4: 'oklch(0.553 0.195 38.402)',
      chart5: 'oklch(0.901 0.076 70.697)',
      sidebarPrimary: 'oklch(0.67 0.173 47.604)',
      sidebarPrimaryForeground: 'oklch(0.985 0 0)',
      sidebarRing: 'oklch(0.67 0.173 47.604)',
      selection: 'oklch(0.67 0.173 47.604)',
      selectionForeground: 'oklch(0.985 0 0)',
    },
    dark: {
      ...
      chart1: 'oklch(0.75 0.183 55.934)',
      chart2: 'oklch(0.67 0.173 47.604)',
      chart3: 'oklch(0.901 0.076 70.697)',
      chart4: 'oklch(0.607 0.176 52.982)',
      chart5: 'oklch(0.949 0.037 80.526)',
      sidebarPrimary: 'oklch(0.75 0.183 55.934)',
      sidebarPrimaryForeground: 'oklch(0.205 0 0)',
      sidebarRing: 'oklch(0.75 0.183 55.934)',
      selection: 'oklch(0.75 0.183 55.934)',
      selectionForeground: 'oklch(0.205 0 0)',
    },
  },
]
